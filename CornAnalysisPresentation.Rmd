...
The purpose of the application is the demonstrate the ability to simulate models and how they are affected by the features selected.
...
## Regression Model Information and Corn Prediction Value

![](statisticaloutput.png)
